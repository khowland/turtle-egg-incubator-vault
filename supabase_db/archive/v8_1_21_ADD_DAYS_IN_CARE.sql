-- Add days_in_care to intake table
ALTER TABLE public.intake ADD COLUMN IF NOT EXISTS days_in_care INT;

-- We also need to update the vault_finalize_intake RPC to accept days_in_care
...
BEGIN
  ...
  INSERT INTO public.intake (
    ...
    intake_condition, days_in_care, extraction_method, discovery_location, carapace_length_mm,
