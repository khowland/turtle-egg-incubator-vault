...
ALTER TABLE public.egg_observation 
  ALTER COLUMN chalking TYPE INTEGER,
...
ALTER TABLE public.egg_observation ALTER COLUMN chalking SET DEFAULT 0;
...
ALTER TABLE public.egg 
  ADD COLUMN IF NOT EXISTS last_chalk INTEGER DEFAULT 0,
...
UPDATE public.egg e
SET 
  last_chalk =   COALESCE((SELECT chalking FROM public.egg_observation WHERE egg_id = e.egg_id ORDER BY timestamp DESC LIMIT 1), 0),
