...
OUTPUT_PATH = ROOT_DIR / "docs" / "user" / "WINC_OPERATOR_MANUAL_v10_5.pdf"

class ClinicalPDF(FPDF):
    def header(self):
        self.set_font('helvetica', 'B', 8)
        self.set_text_color(128, 128, 128)
        self.cell(0, 10, 'WINC Clinical CIOS Reference Manual v10.5.0 (The Institutional Edition)', 0, 0, 'L')
        self.ln(15)
