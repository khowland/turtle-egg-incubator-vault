![WINC Manual Cover Page](../assets/manual/turtle_pond_sunset_cover.png)
...
4. **Chalking Rating**: Select **None**, **Small**, **Medium**, or **Major** based on white calcium coverage.
5. **Vascularity (+)**: Check this box if red veins are visible during candling.
6. **Clinical Health Scales (0-3)**:
