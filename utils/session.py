...
def show_splash_screen():
    ...
    <div style='text-align: center; padding: 50px;'>
        <h1 style='color: #10B981;'>🐢 WINC Incubator Vault</h1>
        <p style='color: #94A3B8;'>Please select your name to begin the session</p>
    </div>
...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        st.divider()
        st.markdown("<div style='text-align: center; color: #64748B; font-size: 0.8rem;'>BUILD: v6.3 — WINC EDITION</div>", unsafe_allow_html=True)
