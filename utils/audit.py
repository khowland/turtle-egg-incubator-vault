...
Dependencies:  utils.db, utils.logger
...
def logged_write(supabase_client, session_id, event_type, payload_dictionary, db_operations_function):
    """
    ...
    try:
        ...
        try:
            supabase_client.table("system_log").insert({
                ...
                "metadata": {"error_details": str(error), "failed_payload": payload_dictionary}
            }).execute()
